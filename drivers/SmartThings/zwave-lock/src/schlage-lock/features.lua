...
local command_params = {
  ...
  [""] = { enable = { parameter = 11, value = -1 }, disable = { parameter = 11, value = 0 }, setInteriorButton = { parameter = 11, argument = "mode", values = {enable = -1, disable = 0} } },
}
